...
> If you haven't already downloaded the data provided for this lesson, please follow the instructions under *Downloading the data* on the [Setup](http://data-lessons.github.io/library-openrefine/setup/) page.
>
...
>2. Click `Choose Files` and locate the file which you have downloaded called `doaj-article-sample.csv`
>3. Click `Next >>`
>   
...
>    
>4. Click in the `Character encoding` box to set it to `UTF-8`
...
>7. Once you are happy click the `Create Project >>` button at the top right of the screen
>
